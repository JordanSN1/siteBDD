...
<head>
    ...
    <style>
        #editUserForm, #addUserForm, #addProductForm, #editProductForm {
            display: none;
            position: fixed;
            top: 50%;
            left: 50%;
        ...
        #editUserForm label, #addUserForm label, #addProductForm label, #editProductForm label {
            display: block;
            margin-top: 10px;
        }

        #editUserForm input, #editUserForm select, #addUserForm input, #addUserForm select,
        ...
        #editUserForm button, #addUserForm button, #addProductForm button, #editProductForm button {
            margin-top: 15px;
            padding: 10px 20px;
        ...
        #editUserForm button:hover, #addUserForm button:hover, #addProductForm button:hover, #editProductForm button:hover {
        ...
        .user-item h3, .product-item h3 {
            margin: 0;
            font-size: 1.2em;
            color: #333;
        }

        .user-item p, .product-item p {
            margin: 5px 0;
            color: #666;
        }

        .user-item button, .product-item button {
            background-color: #4CAF50;
            color: white;
            border: none;
            padding: 8px 16px;
        ...
        .user-item button:hover, .product-item button:hover {
            background-color: #45a049;
        }
    </style>
...
<body>
    ...
    <div class="product-wrapper">
        <div class="product-sort">
            <ul>
                <li>
                    <button onclick="window.location.href='?category=utilisateurs'">Voir les Utilisateurs</button>
                </li>
                <li>
            ...
            <?php if (count($users) > 0): ?>
                <?php foreach ($users as $user): ?>
                    <div class="user-item">
                        ...
                        <p><strong>Role:</strong> <?= htmlspecialchars($user['role_id']); ?></p>
